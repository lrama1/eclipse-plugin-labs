...
import eclipseplugintemplate.wizard.page.panel.Page05Panel;

public class WizardPage05 extends WizardPage {

	public WizardPage05(String pageName) {
		super(pageName);
	...
	public void createControl(Composite parent) {
		Composite container = new Page05Panel(parent, SWT.DOUBLE_BUFFERED);		
